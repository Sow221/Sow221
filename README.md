...
I build software systems where applications, data and machine learning meet to solve concrete problems —<br/>
...
<div>
  ...
  <span><strong>Storybook</strong></span>
</div>

```text
CIF Credit Engine ──► scoring & decision API ──► CIF Credit Platform
 (data · ML · MLOps)                              (decision interface)
```

### TontineSN &nbsp;<sub>🔒 private repository</sub>
...
<div>
  ...
  <span><strong>TensorFlow</strong></span>
  &nbsp;
...
<div>
  ...
  <span><strong>GitHub Actions</strong></span>
  &nbsp;
...
Deepening software architecture, information systems and machine learning engineering — building reliable, data-driven software.
